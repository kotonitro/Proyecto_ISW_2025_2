          ...
          <h2 className="text-xl font-bold text-blue-900 flex items-center gap-2">
            ...
            >
              <path
                ...
                strokeWidth="2"
                d="M9 5v2a2 2 0 002 2h2a2 2 0 002-2V5M7 20h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v11a2 2 0 002 2z"
              />
            </svg>
            Historial
      ...
      <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4 bg-blue-50/50 p-5 rounded-xl border border-blue-100 shadow-sm">
        <div className="relative">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            ...
            <button
              type="submit"
              className="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition-colors shadow-sm flex items-center justify-center"
            >
              <svg
                className="w-4 h-4"
                fill="none"
        ...
        <table className="min-w-full">
          <thead>
            <tr className="bg-blue-50 border-b border-blue-100">
              <th className="px-6 py-4 text-left text-[10px] font-bold text-blue-700 uppercase tracking-wider">
                ID Bicicleta
              </th>
              <th className="px-6 py-4 text-left text-[10px] font-bold text-blue-700 uppercase tracking-wider">
                Usuario
              ...
              <th className="px-6 py-4 text-center text-[10px] font-bold text-blue-700 uppercase tracking-wider">
                Fecha Entrada
              </th>
              <th className="px-6 py-4 text-center text-[10px] font-bold text-blue-700 uppercase tracking-wider">
                Fecha Salida
            ...
            {loading ? (
              ...
              registros.map((r) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center text-xs text-gray-600 font-mono">
                    {r.fechaSalida
                      ? new Date(r.fechaSalida).toLocaleString("es-CL", {
                          year: "numeric",
                          month: "2-digit",
                          day: "2-digit",
                          hour: "2-digit",
