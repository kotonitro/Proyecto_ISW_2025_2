...
export const createInforme = (data) =>
  api.post("/informes", data, {
    headers: { "Content-Type": "multipart/form-data" },
  });

export const downloadInformePdf = (id) =>
  api.get(`/informes/download/${id}`, {
    responseType: "blob",
  });

export const downloadInformeZip = (id) =>
  api.get(`/informes/download-zip/${id}`, {
    responseType: "blob",
  });
