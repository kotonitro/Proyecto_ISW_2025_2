    ...
    return (
      <div className="max-w-2xl mx-auto p-8 text-center">
        ...
        <p className="text-gray-600">
          Por favor, utilice el enlace de seguimiento que se le proporcionó para
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-md border min-h-48 flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <p
                className={`text-2xl font-bold ${
                  estadoSolicitud.estado === "Pendiente"
                    ? "text-yellow-600"
                    : estadoSolicitud.estado === "En Camino"
                    ? "text-blue-700"
                    : "text-green-600"
                }`}
              >
              ...
              <p className="text-sm text-gray-500 mt-3">
                ...
                <br />
                {estadoSolicitud.timestamp
                  ? new Date(estadoSolicitud.timestamp).toLocaleString()
                  : "N/A"}
              </p>
            </div>
          )}
          ...
          {!estadoLoading && !estadoSolicitud && (
            <p className="text-gray-500">
              No se ha cargado el estado de la solicitud.
            </p>
          )}
        </div>
      </div>
