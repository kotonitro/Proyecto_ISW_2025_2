...
export const bicicletaValidation = Joi.object({
  marca: Joi.string()
    ...
    .messages({
      ...
      "string.pattern.base":
        "La marca sólo puede contener letras, números, espacios, guiones y puntos",
  ...
  modelo: Joi.string()
    ...
    .messages({
      ...
      "string.pattern.base":
        "El modelo sólo puede contener letras, números, espacios, guiones y puntos",
  ...
  idUsuario: Joi.number().integer().required().messages({
    "number.base": "El idUsuario debe ser un número",
